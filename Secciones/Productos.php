<section class="section">
    ...
    <div class="banner position-relative">
        ...
        <div class="position-absolute bottom-0 start-50 translate-middle-x">
            <img style="width: 100vh; height: auto" src="/images/laptop.png" alt="Alternate Text" />
        </div>
    </div>
</section>
    ...
    <div class="text-center text-lg-start">
        <div class="container text-center text-md-start pt-5">
            <div class="row mt-5 mb-0 pt-5">
                <div class="col-md-10 col-lg-4 col-xl-4 mx-auto pt-5 mb-5 mt-5">
                    <h1 class="text-primary fs-1">
                        <span class="text-dark">Transforma </span>la<br />
                ...
                <div class="col-md-10 col-lg-4 col-xl-6 mx-auto mb-5 mt-5 pt-5">
                    <p class="fs-3 lh-sm text-center">
                        El Módulo de Nómina y Capital Humano GIRO está diseñado para optimizar la gestión de tu empresa
                        <br /><br />
                        Te proporciona una solución integral que se adapta a tus necesidades
                        <br /><br />
                        Enfócate en lo más importante: el crecimiento de tu negocio y el bienestar de tu equipo.
                    </p>
                </div>
            </div>
        </div>
...
<section class="section p-5 mx-5">
    <div class="row justify-content-center mt-5 pt-5 mx-5">
        <div class="col-5 col-md-4 col-lg-3 col-xl-2 mb-4 pt-5 mx-5">
            <div class="card text-center" style="border: none">
                <i class="bi bi-check-circle card-img-top rounded-circle"></i>
                <div class="card-title pt-5 pb-3 px-1 rounded-5">
                    <p class="card-text fs-4">Libre de errores</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-5 col-md-4 col-lg-3 col-xl-2 mb-4 pt-5 mx-5">
            <div class="card text-center" style="border: none">
                <i class="bi bi-clock-history card-img-top rounded-circle"></i>
                <div class="card-title pt-5 pb-3 px-1 rounded-5">
                    <p class="card-text fs-4">Pago puntual a tus empleados</p>
                </div>
            </div>
        </div>
        <div class="col-5 col-md-4 col-lg-3 col-xl-2 mb-4 pt-5 mx-5">
            <div class="card text-center" style="border: none">
                <i class="bi bi-shield-check card-img-top rounded-circle"></i>
                <div class="card-title pt-5 pb-3 px-1 rounded-5">
                    <p class="card-text fs-4">Ahorra tiempo en capturas y procesos</p>
                </div>
            </div>
        </div>
        <div class="col-5 col-md-4 col-lg-3 col-xl-2 mb-4 pt-5 mx-5">
            <div class="card text-center" style="border: none">
                <i class="bi bi-lightbulb card-img-top rounded-circle"></i>
                <div class="card-title pt-5 pb-3 px-1 rounded-5">
                    <p class="card-text fs-4">Rapida y eficiente</p>
                </div>
            </div>
        </div>
        <div class="col-5 col-md-4 col-lg-3 col-xl-2 mb-4 pt-5 mx-5">
            <div class="card text-center" style="border: none">
                <i class="bi bi-collection card-img-top rounded-circle"></i>
                <div class="card-title pt-5 pb-3 px-1 rounded-5">
                    <p class="card-text fs-4">Control de multiples empresas dentro del sistema</p>
                </div>
            </div>
        </div>
        <div class="col-5 col-md-4 col-lg-3 col-xl-2 mb-4 pt-5 mx-5">
            <div class="card text-center" style="border: none">
                <i class="bi bi-currency-dollar card-img-top rounded-circle"></i>
                <div class="card-title pt-5 pb-3 px-1 rounded-5">
                    <p class="card-text fs-4">Flexibilidad en ciclos de pago</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="section">
    ...
    <div class="text-center text-lg-start">
        <div class="container text-center text-md-start pt-5">
            <div class="row mt-5 mb-0 pt-5">
                <div class="col-md-10 col-lg-4 col-xl-6 mx-auto pt-5 mb-5 mt-5">
                    <h1 class="text-white">
                        Nuestro sistema es<br />
                        <span class="fw-bold">100% programable</span>
                    </h1>
                    <br />
                    <h2 class="text-white">
                ...
                <div class="col-md-10 col-lg-4 col-xl-6 mx-auto mb-5 mt-5 pt-5">
                    <div class="position-relative">
                        <div class="position-" style="top: 18vh">
                            ...
                            <img src="images/bman.png" style="width: 50vh; height: auto" />
