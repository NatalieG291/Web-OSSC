...
Webflow.require('ix').init([
    ...
    { "slug": "fade-in-heading-a", "name": "Fade in heading", "value": { "style": { "opacity": 0, "x": "0px", "y": "-30px" }, "triggers": [{ "type": "scroll", "offsetTop": "10%", "offsetBot": "10%", "stepsA": [{ "wait": 300 }, { "opacity": 1, "transition": "transform 1200ms ease-out-cubic 0ms, opacity 1200ms ease 0ms", "x": "0px", "y": "0px" }], "stepsB": [{ "wait": 300 }, { "opacity": 0, "transition": "transform 1200ms ease-out-cubic 0ms, opacity 1200ms ease 0ms", "x": "0px", "y": "-30px" }] }] } },
    { "slug": "fade-from-left", "name": "Fade from left", "value": { "style": { "opacity": 0 }, "triggers": [{ "type": "scroll", "offsetTop": "10%", "offsetBot": "10%", "stepsA": [{ "x": "-50px", "y": "0px" }, { "opacity": 1, "transition": "transform 750ms ease 0ms, opacity 750ms ease 0ms", "x": "0px", "y": "0px" }], "stepsB": [{ "opacity": 0, "transition": "transform 750ms ease 0ms, opacity 750ms ease 0ms", "x": "-50px", "y": "0px" }, { "transition": "transform 750ms ease 0ms", "x": "0px", "y": "0px" }] }] } },
